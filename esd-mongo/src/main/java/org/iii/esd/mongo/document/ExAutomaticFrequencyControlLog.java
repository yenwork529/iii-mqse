...
@ToString
@Builder
@Document(collection = "ExAutomaticFrequencyControlLog")
// @CompoundIndexes({
// @CompoundIndex(def = "{'afcId':1, 'timestamp':1}",
// name = "pk_automaticFrequencyControlLog",
// unique = true)
// })
public class ExAutomaticFrequencyControlLog extends UuidDocument {
    ...
    /**
     * Hertz(Hz)頻率(修正頻率: 考慮臨界值的問題，此欄位的值一定會界於59.50和60.50之間，績效模組將使用此一欄位值計算sbspm) e.g.
     * 若實際頻率超出60.50，則為60.50; 若實際頻率不足59.50，則為59.50)
     */
    ...
    public ExAutomaticFrequencyControlLog(String txGuid, Integer resId) {
        super();
        this.txGuid = txGuid;
        this.resId = resId;
        // this.automaticFrequencyControlProfile = new AutomaticFrequencyControlProfile(afcId);
    }
