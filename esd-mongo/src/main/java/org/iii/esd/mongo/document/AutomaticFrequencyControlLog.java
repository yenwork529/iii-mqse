...
@ToString
@Builder
@Document(collection = "AutomaticFrequencyControlLog")
@CompoundIndexes({
        @CompoundIndex(def = "{'afcId':1, 'timestamp':1}",
                name = "pk_automaticFrequencyControlLog",
                unique = true)
})
public class AutomaticFrequencyControlLog extends UuidDocument {
    ...
    public AutomaticFrequencyControlLog(Long afcId) {
        super();
